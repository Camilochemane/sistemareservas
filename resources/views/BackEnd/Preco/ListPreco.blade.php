       ...
       <div class="container">
          ...
          <div id="table-datatables">
              ...
              <div class="input-field col s4">
                  <h4 class="header">Lista dos preços</h4>
              </div>
              <div class="input-field col s8">
                       {!!Form::open(['route'=>'preco.pesquisar', 'method' => 'POST', 'role' => 'form', 'id' => 'checkout-form', 'enctype'=>'multipart/form-data'])!!}
                        <div class="input-field col s4" id="" >
                           <select id="type" name="servico_id" >
                                <option value="" disabled selected>--Valor do serviço--</option>
                              @foreach($servico as $servicos)
                                <option value="{!!$servicos->id!!}">{{$servicos->name}}</option>
                              @endforeach
                        </select>
                        </div>
                        <div class="input-field col s4" id="" >
                          <input id="servico" type="text" autocomplete="new-password" name="servico" >
              ...
              <div class="row">
                  ...
                  <div id="data-table-simple_wrapper" class="dataTables_wrapper"><table id="data-table-simple" class="responsive-table display dataTable" cellspacing="0" role="grid" aria-describedby="data-table-simple_info">
                    <thead>
                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 240;">Valor</th><th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 400;">Descrição</th><th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 400;">Serviço</th><th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 240px;">Acção</th></tr>
                    </thead>
                    ...
                    <tbody>
                      @foreach($preco as $precos)
                        <tr>
                          <td>{!!$precos->valor!!}</td>
                          <td>{!!$precos->descricao!!} </td>
                          <td>{!!$precos->serv->name!!} </td>
                            <td>
                              <a href="" class="btn waves-effect waves-light  teal darken-2">Ver</a>
                              <a href="{!!route('edit.preco',$precos->id)!!}" class="btn waves-effect waves-light  yellon darken-2">Editar</a>
                            </td>
                    </tr>
                  @endforeach                   
          </tbody>
