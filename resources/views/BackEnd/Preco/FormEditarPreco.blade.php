        ...
        <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Formulario para eitar Preço </h4>
                <div class="row">
                {!!Form::model($preco, ['route'=>['preco.actualizar', $preco->id], 'method' => 'put', 'role' => 'form', 'id' => 'checkout-form'])!!}

                      {{ csrf_field() }}
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="first_name" type="text" name="valor" value="{!!$preco->valor!!}">
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        <textarea id="textarea1" class="materialize-textarea" name="descricao" value="{!!$preco->valor!!}"></textarea>
