        ...
        <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                ...
                <div class="row">
          {!!Form::model($user,['route' => ['user.atualizar', $user->id],'method' => 'put', 'role' => 'form', 'id' => 'checkout-form'])!!}
                      {{ csrf_field() }}
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="first_name" type="text" name="name" value="{!!$user->name!!}">
                        <label for="first_name">Nome</label>
                      </div>
                    
                      <div class="input-field col s6">
                        <input id="last_name" type="text" name="Apelido" value="{!!$user->Apelido!!}">
                    ...
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="email5" type="email" name="email" value="{!!$user->email!!}">
                     ...
                     <div class="row">
                      ...
                      <div class="input-field col s6">
                        <input id="phone" type="number" name="telefone" value="{!!$user->telefone!!}">
