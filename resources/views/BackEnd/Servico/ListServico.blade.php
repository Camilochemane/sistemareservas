       ...
       <div class="container">
          ...
          <div id="table-datatables">
              ...
              <div class="input-field col s8">
                       {!!Form::open(['route'=>'servico.pesquisar', 'method' => 'POST', 'role' => 'form', 'id' => 'checkout-form', 'enctype'=>'multipart/form-data'])!!}
                        <div class="input-field col s4" id="" >
                           <select id="type" name="categoria" >
                    ...
                    <tbody>
                      @foreach($servico as $servicos)
                        <tr>
                          ...
                          <td>{!!$servicos->category->designacao!!} </td>
                            <td>
                              <a href="" class="btn waves-effect waves-light  teal darken-2">Ver</a>
                              <a href="{!!route('edit.servico',$servicos->id)!!}" class="btn waves-effect waves-light  yellon darken-2">Editar</a>
                            </td>
                    </tr>
                  @endforeach                   
          </tbody>
          ...
          @if(isset($dataForm))
          {{$servico->appends($dataForm)->links()}}
          @else
          {{$servico->links()}}
          @endif
        </div>
